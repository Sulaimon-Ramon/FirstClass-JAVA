...
public class HelloWorld {
    public static void main(String[] args) {
        ...
        System.out.println("The Product is : " + thirdResult);
        System.out.println("The Quotient is : " + fourthResult);
        ...
        if (personAge >= 18) {
            ...
            if (hasID.equalsIgnoreCase("Yes")) {
                ...
                System.out.println("Sorry!, You need an ID to be a member");
            }
        } else {
        ...
        float newNumber = (float)numberOfPages;

        // Explicit Type Casting
        double results = Double.parseDouble(page);

        System.out.printf("The Total pages in the book is: %f\n", newNumber);
        System.out.printf("The Total pages in the book is: %f", results);
